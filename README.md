...
[утилита](https://ru.wikipedia.org/wiki/%D0%A3%D1%82%D0%B8%D0%BB%D0%B8%D1%82%D0%B0), производящая анализ [access.log](https://ru.wikipedia.org/wiki/Access.log).
...
Потоковая обработка: чтение файла по строкам без загрузки всего лога в память.

Регулярные выражения: для надёжного парсинга каждой записи.

Структурированный код: классы LogAnalyzer и LogEntry.

Минимальные зависимости: только стандартная библиотека C++17.

### План дальнейшего развития:

Добавить поддержку анализа 4XX ошибок.

Визуализация графика количества запросов во времени.

Реализация многопоточности для больших файлов.

Веб-интерфейс для отображения отчётов в режиме реального времени.
